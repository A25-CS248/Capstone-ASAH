...
* Recency (R): Seberapa baru pelanggan melakukan transaksi terakhir⏱️
...
### **III. 🏷️ Informasi Produk (Product Information)**

Detail spesifik mengenai barang yang dibeli:

* **Product Category:** Kategori produk yang dibeli (misalnya, elektronik, pakaian, buku)🗂️.
* **Product Name:** Nama produk yang dibeli🏷️.
